document.addEventListener('DOMContentLoaded', function() {
  ...
  const API_URL = '/api/compatibility'; // Change this based on your deployment
  ...
  // Show loading, hide results initially
  ...
  function displayResults(name1, name2, compatibility) {
    console.log("Displaying results:", name1, name2, compatibility);
